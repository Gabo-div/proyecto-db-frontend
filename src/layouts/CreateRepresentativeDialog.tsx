...
import { createRepresentativeAction } from "@/actions/representative";
...
export default function CreateRepresentativeDialog() {
  ...
  const onSubmit = async (data: Inputs) => {
    const result = await createRepresentativeAction(data);
    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Crea un nuevo representante.</DialogDescription>
          <Form {...form}>
            <form
